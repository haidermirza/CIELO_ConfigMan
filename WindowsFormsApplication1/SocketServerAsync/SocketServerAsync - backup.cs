...
//                    if (!CreatePackets(RxMessage,out lstMsgs))
//                    {

//                        lstMsgs.ToList().Where(Rxmsg => Rxmsg.Length > 0).ToList().ForEach(msg =>
//                        {
//                            if (OnMessageReceived != null)
//                                OnMessageReceived(msg, Client);
//                            objSocketState.Buffer = new byte[1024];
//                            objSocketState.MessageBuilder.Clear();
//                            if (msg.Contains("BOOT"))
//                                Client.Send(Encoding.ASCII.GetBytes("$ACK BOOT#"));
//                            else if (msg.Contains("HEARTBEAT"))
//                                Client.Send(Encoding.ASCII.GetBytes("$ACK HB#"));
//                        });
//                        Client.BeginReceive(objSocketState.Buffer, 0, objSocketState.Buffer.Length, 0,
//                        new AsyncCallback(OnDataRecived), objSocketState);
//                    }
...
//                    //if (RxMessage.IndexOf("#") > -1)
//                    //{
//                    //    string[] msgs = RxMessage.Split('#');

//                    //    //if (OnMessageReceived != null)
//                    //    //    OnMessageReceived(objSocketState.ClientSocket.LocalEndPoint + ";" + RxMessage.Replace("<EOF>", ""));
//                    //    msgs.ToList().Where(Rxmsg => Rxmsg.Length > 0).ToList().ForEach(msg =>
//                    //        {
//                    //            if (OnMessageReceived != null)
//                    //                OnMessageReceived(msg, Client);
//                    //            objSocketState.Buffer = new byte[1024];
